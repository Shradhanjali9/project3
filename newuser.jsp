...
<form action="newuser1.jsp" >
Check User Mail ID <input type="email" name="t1" required /> <input type="submit" value="Go" />
</form> <br />
<%
try{
	String  z1=request.getParameter("a1");
	if(z1.equals("error")){
		out.print("<font color=red size=3>Username is  available. Try Another !!</font>");
	}
}catch(Exception e){  }
