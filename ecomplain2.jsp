    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <p class="infopost">Complain Solved Status</p>

<%
try{ 
String paid=request.getParameter("paid");
String solu=request.getParameter("solu");
String dt = new java.text.SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new java.util.Date());

st.executeUpdate("update problemstatus set compdt='"+dt+"', solu='"+solu+"', status='Completed' where paid='"+paid+"'");
out.println();
st.executeUpdate("update problemalert set hodstat='Finished', status='Completed' where paid='"+paid+"'");
out.print("<font color=green size=+1>Complain is Processed.</font>");
con.close();
